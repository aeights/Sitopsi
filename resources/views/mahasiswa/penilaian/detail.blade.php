            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Nilai Matrix</h4>
                        <a href="{{ route('mahasiswa.penilaian.generate_pdf', $id) }}" class="btn btn-danger">Cetak</a>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <div id="example_wrapper" class="dataTables_wrapper">
                                <table id="example1" class="display dataTable" style="min-width: 845px" role="grid"
            ...
            {{-- <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <div id="example_wrapper" class="dataTables_wrapper">
                                <table class="display dataTable" style="min-width: 845px" role="grid"
                                    aria-describedby="example_info">
                                    <thead>
                                        <tr role="row">
                                            <th>Kode</th>
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <div id="example_wrapper" class="dataTables_wrapper">
                                <table id="example1" class="display dataTable s" style="min-width: 845px" role="grid"
                                    aria-describedby="example_info">
                                    <thead>
                                        <tr role="row">
                                            <th>Kode</th>
