...
@section('content')
    <div class="card mx-4">
        <div class="card-header">
            ...
            <button type="button" onclick="updatePasswordMahasiswa()" class="btn btn-outline-primary">Simpan</button>
        </div>
        <div class="card-body">
            <div class="basic-form">
                <form id="form-change-password-mahasiswa" action="{{ route('mahasiswa.change.password') }}" method="POST">
                    @csrf
...
@push('script')
    <script>
        function updatePasswordMahasiswa() {
            const form = document.getElementById('form-change-password-mahasiswa');
            form.submit();
        }
    </script>
@endpush